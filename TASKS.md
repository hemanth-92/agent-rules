...
## Phase 1 — Portable kit foundation
...
- [x] Claude and Grok optional install targets
- [x] Project doc bootstrap script
- [ ] Optional Windows PowerShell installer (if needed)

## Phase 3 — Skill growth

- [ ] Add skills only when repeated workflows justify them
